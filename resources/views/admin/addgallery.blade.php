            ...
            <div class="col-md-8 p-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        <label>Add GalleryImage:</label><input type="file" name="galleryimage"
                            class="form-control shadow-lg mt-2">
                    </div>

                    <div class="form-group mt-3">
                        <textarea name="descriptions" placeholder="Enter Gallery Descriptions *" class="form-control shadow-lg"></textarea>
                    </div>
                    <div class="form-group mt-3">
                        <input type="submit" name="addgallery" value="Add Gallery"
