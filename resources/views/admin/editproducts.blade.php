<x-app-layout>
    ...
    <div class="container mt-5 bg-white p-4">
        <h2 class="mt-3 text-center" style="font-size:30px">Edit Your Products
        </h2>
            ...
            <div class="col-md-8 p-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select name="categoryname" placeholder="select
                            category"
                            class="form-control">
                            <option value="">--select category--</option>
                            <!-- array as values -->
                            @foreach ($category as $category1)
                                @if ($ed->category_id == $category1->id)
                                    <option value="{{ $ed->category_id }}" selected>{{ $category1->categoryname }}
                                    </option>
                                @else
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select name="subcategoryname" placeholder="Select Subcategory" class="form-control">
                            ...
                            @foreach ($subcategory as $subcategory1)
                                @if ($ed->subcategory_id == $subcategory1->id)
                                    <option value="{{ $ed->subcategory_id }}" selected>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" name="productname" value="{{ $ed->productname }}"
                            placeholder="Enter Productname*" class="form-control shadow-lg">
                    </div>
                    <div class="form-group mt-3">
                        <img src="{{ asset('uploads/products/' . $ed->productimage) }}" width="85px" height="75px"
                            class="card" alt="No image" width="85px" height="75px">
                        <input type="file" name="productimage" value="{{ $ed->productimage }}"
                            class="form-control shadow-lg">
                    </div>
                    <div class="form-group mt-3">

                        <input type="text" name="qty" value="{{ $ed->qty }}" placeholder="Enter Qty*"
                            class="form-control shadow-lg">
                    </div>
                    <div class="form-group mt-3">

                        <input type="text" name="oldprice" value="{{ $ed->oldprice }}"
                            placeholder="Enter  
                            Oldprice*" class="form-control shadow-lg">
                    </div>
                    <div class="form-group mt-3">

                        <input type="text" name="offerprice" value="{{ $ed->offerprice }}"
                            placeholder="Enter
                    ...
                    <div class="form-group mt-3">
                        <input type="submit" name="addproducts" value="Update Products"
