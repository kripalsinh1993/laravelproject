<x-app-layout>
    ...
    <div class="container mt-5 bg-white p-4">
        <h2 class="mt-3 text-center" style="font-size:15px">Edit Your Blogs
        </h2>
        <hr class="border border-2 w-50 mx-auto">
        <div class="row">
            <div class="col-md-4 mt-5">
                <ul>
                    <li class="list-unstyled"><a href="/addblog" class="text-dark text-decoration-none">Add
                            Blog</a></li>
            ...
            <div class="col-md-8 p-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        <div class="form-group mt-3">
                            <input type="text" name="blogstitle" value="{{ $ed->blogstitle }}"
